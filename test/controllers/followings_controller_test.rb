...
class FollowingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create following" do
    assert_difference('Following.count') do
      post followings_url, params: { following: { chef_id: @following.chef_id, is_favorite: @following.is_favorite, user_id: @following.user_id } }
    end
  ...
  test "should update following" do
    patch following_url(@following), params: { following: { chef_id: @following.chef_id, is_favorite: @following.is_favorite, user_id: @following.user_id } }
