...
Dish.create(chef_id: 7, name: "Bandeja Paisa", price: 25000, calories: 5000, score: 4.2, picture: "http://cdn.colombia.com/sdi/2011/08/02/bandeja-paisa-500926.jpg",description: "Una plato monstruoso. La bandeja paisa viene con carne molida, chicharrón de cerdo, aguacate, salsa, huevo, fríjoles, arroz, una arepa pequeña, y con frecuencia, 2 o 3 tipos de embutidos. Como el nombre lo dice, es más común en la zona paisa del país y encontrará la porción más grande y deliciosa en Medellín.")
Dish.create(chef_id: 7, name: "Pescado Frito", price: 17000, calories: 2200, score: 4.0, picture: "http://cdn.noticiaaldia.com/wp-content/uploads/2015/08/00041517915417f854ff2d94f7acd3b8.jpg", description: "Hay muchas variaciones de este plato, pero las más populares vienen con Mojarra, Bagre o Sierra. El pescado se fríe entero así que la mayoría de veces se sirve tal como vino del agua, acompañado de arroz, fríjoles, ensalada y plátano frito.")
...
Dish.create(chef_id: 7, name: "Mondongo antioqueño", price: 22000, calories: 4200, score: 4.6, picture: "http://www.freeiconspng.com/uploads/food-png-6.png", description: "El mondongo es una sopa que se prepara con la carne del estomago de res, limpia y cortada en trozos finos; carne blanda de cerdo, también cortada en trocitos; varios vegetales y verduras, todo cocinado por largo tiempo y acompañado de aliños y especias")
Dish.create(chef_id: 7, name: "Ajiaco santafereño", price: 7000, calories: 1300, score: 4.9, picture: "http://www.freeiconspng.com/uploads/food-png-6.png",description: "Plato tipico bogotano. Consiste en una sopa de pollo que contiene diferentes tipos de papa y se puede servir sola o con crema de leche y alcaparras encurtidas, generalmente en tazones de barro cocido. El ajiaco colombiano también suele incluir mazorcas de maíz tierno.
SE ACOMPAÑA DE AGUACATE, ARROZ BLANCO.")
Dish.create(chef_id: 8, name: "Buñuelo de maiz", price: 3000, calories: 1200, score: 4.1, picture: "http://www.freeiconspng.com/uploads/food-png-6.png", description: "Son preparados con maiz biche molido,cebollin,ajo. Se acompañan con queso.")
